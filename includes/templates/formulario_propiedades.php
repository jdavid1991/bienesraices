...
<fieldset>
  ...
  <input type="number" id="estacionamiento" name="propiedad[estacionamiento]" placeholder="Ej: 3" max="9" min="1" value="<?php echo s($propiedad->estacionamiento); ?>">
...
<fieldset>
  ...
  <select name="propiedad[vendedores_id]" id="vendedor">
    <option selected value="">-- Seleccionee --</option>
